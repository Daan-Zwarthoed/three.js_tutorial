      ...
      <div className="flex flex-row h-full">
        <div className="p-5 w-full">
          ...
          <p>
            ...
            Three.js comes with several materials, but we'll stick to the
...
scene.add(cube);`}</CodeBlockInline>
          ...
          <p>Succes!</p>
          <p>
            Take note of the fact we moved the camera back a bit. This is
            because anything added to the scene will by default be added at the
